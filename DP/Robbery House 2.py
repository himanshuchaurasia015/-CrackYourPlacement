...
# For example:
# (i) Given the input array arr[] = {2, 3, 2} the output will be 3 because Mr X cannot rob house 1 (money = 2) 
# and then rob house 3 (money = 2), 
# because they are adjacent houses. So, he’ll rob only house 2 (money = 3)

# (ii) Given the input array arr[] = {1, 2, 3, 1} the output will be 4 because Mr X rob house 1 (money = 1) 
...
#  because they are adjacent houses (remember, it’s a circular street). 
# So, he’ll rob only house 2 (money = 3) with a maximum value

# (iii) Mr. X will get maximum value when he robs house 2 (money = 3) and
#  then robs house 4 (money = 1) i.e. 4 units of money.
